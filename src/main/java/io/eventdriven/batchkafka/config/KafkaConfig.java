...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, 200); // 한 번에 200개씩 처리 (메모리 부담 감소)
        configProps.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false); // 수동 커밋 (처리 완료 후 커밋)
        configProps.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, 300000); // 5분 (안정성 증가)
